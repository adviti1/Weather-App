...
export const MAJOR_CITIES = [
  ...
  "Seoul", "Istanbul", "Mexico City", "São Paulo", "Jakarta", "Bangkok", "Moscow",
...
export const WEATHER_ICONS: Record<string, React.ReactNode> = {
  ...
  Cloudy: (
    <svg width="48" height="48" className="w-12 h-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
